...
const values = [
  ...
  {
    title: "Innovation",
    description: "We embrace innovation and continuously seek new ways to solve problems and create value.",
    icon: (
      <svg className="w-8 h-8 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    title: "Integrity",
    description: "We operate with honesty and transparency, building trust through our actions and words.",
    icon: (
      <svg className="w-8 h-8 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
