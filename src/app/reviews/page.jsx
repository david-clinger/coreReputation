...
const reviews = [
  {
    ...
    rating: 5,
    content: 'NovaAIQ has completely transformed how we handle customer reviews. The AI-powered responses are so natural, and we\'ve seen a 40% increase in positive reviews since using their platform.',
    date: '1 week ago'
  },
  {
    id: 2,
    ...
    rating: 5,
    content: 'Managing online reviews used to take hours each week. Now NovaAIQ handles everything automatically, and our online reputation has never been better. Our patient bookings have increased by 35%.',
    date: '2 weeks ago'
  },
  {
    id: 3,
  ...
  },
  {
    ...
    role: 'Shop Owner',
    rating: 5,
    content: 'NovaAIQ helped us go from 3.2 to 4.8 stars on Google in just 4 months. The review invitation system and smart response generation has brought us so many new customers.',
    date: '1 month ago'
  },
  {
    id: 5,
  ...
  },
  {
    ...
    role: 'Pharmacy Owner',
    rating: 5,
    content: 'Customer review anxiety is gone! NovaAIQ handles negative reviews professionally and helps us collect more positive ones. Our community trust has grown significantly.',
    date: '2 months ago'
  },
  {
    id: 7,
    ...
    rating: 5,
    content: 'Professional reputation is everything in law. NovaAIQ ensures we maintain our excellent online presence while saving us hours of manual review management each month.',
    date: '2 months ago'
  },
  {
    id: 8,
    ...
    role: 'Restaurant Owner',
    rating: 5,
    content: 'From 3.5 to 4.7 stars in 5 months! The AI responses sound just like me talking to customers. NovaAIQ has brought our family business into the digital age.',
    date: '3 months ago'
  },
  {
    id: 9,
    ...
    role: 'Veterinarian',
    rating: 5,
    content: 'Pet owners are very emotional about reviews. NovaAIQ helps us respond with empathy and professionalism to every situation. Our online reputation reflects our caring approach.',
    date: '3 months ago'
  }
]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Real stories from businesses that transformed their online reputation with NovaAIQ&apos;s 
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Verified NovaAIQ Reviews</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              See authentic reviews from businesses using NovaAIQ&apos;s AI-powered review management platform across various review platforms.
            </p>
          </motion.div>
